### Transcript corrrections:

# Episode 1

- Incorrectly identifies desus and mero (needs_review)

# Episode 2

- Speakers are switched (needs_review)
...
- Speaker C is Ben Carson / Mero (needs_resolution)

# Episode 5 (teacher)

- Speakers completely misattributed (A: Desus, B: Mero, C: Desus)

# Episode 6

- Speakers are switched: Desus should be Mero, Mero should be Desus

# Episode 7

- Tyler Beckford is Mero (needs_resolution)
...
- Intro skit categorized incorrectly, Michael McDonald impression & whole intro done by Mero. Desus and Mero utterances are switched and partially parsed incorrectly at beginning
...
- Alex Rodriguez is Mero

# Episode 20

- Speakers are switched, correction did NOT catch this

# Episode 21.5

- Speaker are switched
...
- Speakers are switched (script didnt catch)
...
# Episode 37 (Akas in full effect now )
...
- speakers are switched (script missed this)
